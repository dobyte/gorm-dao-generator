...
var (
	...
	subPkgEnable  = flag.Bool("sub-pkg-enable", false, "specify whether to enable sub-pkg; default disable")
	subPkgStyle   = flag.String("sub-pkg-style", "kebab", "specify the generation style for sub-pkg; options: kebab | underscore | lower | camel | pascal; default is kebab")
